...
export const tenants = pgTable('tenants', {
  ...
  lateFeePerDay:numeric('late_fee_per_day', { precision: 8, scale: 2 }).notNull().default('5.00'),
  depositPct:   numeric('deposit_pct', { precision: 5, scale: 2 }).notNull().default('0.50'),
  rentalBuffer: integer('rental_buffer').notNull().default(1),
